...
//      S1			S2		S3		S4		S5		S6		S7		S8		S9		S10		S11		S12			S13		S14		S15		S16
        KC_MENU,	KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_EXECUTE,	KC_NO,  KC_NO,  KC_NO,  KC_NO,

//      S23		S24		S25		S26		S27		S28		S29		S30		S31		S32					S33				S34			S35		S36			S37		S38
        KC_F4,	KC_F5,	KC_F6,	KC_F7,	KC_F8,	KC_F9,	KC_F10,	KC_F11,	KC_F12,	KC_PRINT_SCREEN,	KC_SCROLL_LOCK,	KC_HELP,	KC_NO,	KC_AGAIN,	KC_NO,	KC_NO,

//      S46		S47		S48		S49		S50		S51		S52		S53		S54		S55			S56			S57				S39			S40		S41		S42
        KC_2,	KC_3,	KC_4,	KC_5,	KC_6,	KC_7,	KC_8,	KC_9,	KC_0,	KC_MINUS,	KC_EQUAL,  KC_BACKSPACE,	KC_DELETE,	KC_NO,  KC_UP,  KC_NO,

//      S65		S66		S67		S68		S69		S70		S71		S72		S73		S74					S75					S76		S58			S59			S60			S61
        KC_W,	KC_E,	KC_R,	KC_T,	KC_Y,	KC_U,	KC_I,	KC_O,	KC_P,	KC_LEFT_BRACKET,	KC_RIGHT_BRACKET,	KC_TAB,	KC_INSERT,	KC_LEFT,	KC_DOWN,	KC_RIGHT,

//      S84	S85			S86		S87		S88		S89		S90		S91		S92		S93				S94			S95				S77			S78		S79		S80
        KC_A,	KC_S,	KC_D,	KC_F,	KC_G,	KC_H,	KC_J,	KC_K,	KC_L,	KC_SEMICOLON,	KC_QUOTE,	KC_NONUS_HASH,	KC_HOME,	KC_P7,	KC_P8,	KC_P9,

//      S103	S104	S105	S106	S107	S108	S109	S110		S111	S112		S113			S114		S96				S97		S98		S99
        KC_Z,	KC_X,	KC_C,	KC_V,	KC_B,	KC_N,	KC_M,	KC_COMMA,	KC_DOT,	KC_SLASH,	KC_RIGHT_SHIFT,	KC_ENTER,	KC_KP_MINUS,	KC_P4,	KC_P5,	KC_P6,

//      S21		S22		S45		S64		S121	S83				S122	S102				S123		S124	S125	S126	S115			S116	S117	S118
        KC_F2,	KC_F3,	KC_1,	KC_Q,	KC_NO,	KC_LEFT_CTRL,	KC_NO,	KC_NONUS_BACKSLASH,	KC_SPACE,	KC_NO,  KC_NO,  KC_NO,  KC_KP_ENTER,	KC_P1,  KC_P2,  KC_P3,
        
//      S44			S20		S63		S82				S101			S120	S81		S100		S119	S130		S129	S128		S62				S43		S19		S17
        KC_ESCAPE,	KC_F1,	KC_TAB,	KC_CAPS_LOCK,	KC_LEFT_SHIFT,	KC_NO,	KC_END,	KC_KP_PLUS,	KC_NO,	KC_KP_DOT,	KC_NO,	KC_KP_0,	KC_KP_ASTERISK,	KC_NO,  KC_NO,  KC_NO
    )
};
